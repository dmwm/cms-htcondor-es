...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        help=(
            "Read ads from this pickle file. "
    ...
    parser.add_argument(
        ...
        default=1000,
        type=int,
        dest="n_docs_to_query",
        help=("Number of documents to test on " "[default: %(default)d]"),
    )
    parser.add_argument(
        "--n_schedds_to_query",
        default=5,
        type=int,
        dest="n_schedds_to_query",
        help=("Number of schedds to test on " "[default: %(default)d]"),
    )
    parser.add_argument(
        "--schedd_filter",
        default="",
    ...
    parser.add_argument(
        ...
        type=str,
        dest="dump_target",
        help=("Dump converted documents here " "[default: %(default)d]"),
    )
